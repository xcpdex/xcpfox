...
class PiechartsController extends Controller
{
    ...
    {
        return \Cache::remember('api_piecharts_addresses', 2880, function() {
    ...
    {
        return \Cache::remember('api_piecharts_assets', 2880, function() {
    ...
    {
        return \Cache::remember('api_piecharts_blocks', 2880, function() {
    ...
    {
        return \Cache::remember('api_piecharts_messages', 2880, function() {
    ...
    {
        return \Cache::remember('api_piecharts_transactions', 2880, function() {
